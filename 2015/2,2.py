...
for present_size in dimensions.splitlines():
    ...
    sorted_sides = sorted([2*l, 2*w, 2*h])
    ribbon_sides = sorted_sides[0] + sorted_sides[1]
    ribbon_vol = l * w * h
    ribbon_full_length = ribbon_full_length + ribbon_sides + ribbon_vol

print(ribbon_full_length)